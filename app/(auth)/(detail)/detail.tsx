  ...
  useEffect(() => {
    const loadBanks = async () => {
      ...
      if (lastUsedBankCode) {
        ...
        if (lastUsedBankIndex > -1) { // Check if found
        ...
        if (canOpen) {
          ...
          if (item?.type === 'store') {
            setVietQRBanks((currentBanks) => {
              ...
              if (bankIndex > 0) { // Only move if not already first
            ...
            <View style={styles.transferContainer}>
              ...
              <View style={styles.transferSection}>
                ...
                <View style={styles.inputWrapper}>
                  ...
                  >
                    <ThemedText
                      style={[styles.currencyText, { color: currencyTextColor }]}
                    >
                      đ
                    </ThemedText>
                  </View>
                ...
                <FlatList
                  ...
                  keyExtractor={(suggItem, index) => `suggestion-${suggItem}-${index}`} // Add index for safety
